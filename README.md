...
3) evaluate_challange_dataset.ipynb notebook for evaluating trained models with challange datasets. To run this notebook, one must download both trained models from the following link:
   https://drive.google.com/drive/folders/1wsJXgd4Z4RcvuXZKaKuoDz5v2WXAlY-A?usp=sharing
